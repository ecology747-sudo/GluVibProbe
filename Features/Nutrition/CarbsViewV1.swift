...
//  GluVibProbe
//
//  Nutrition V1 — Carbs Detail Screen
//
//  Purpose
//  - Renders the carbohydrate metric detail screen for the Nutrition domain.
//  - Shows the current carbs hint state, KPI block, daily / period / monthly charts,
//    and the shared nutrition metric chip navigation.
//
//  Data Flow (SSoT)
//  Apple Health → HealthStore (SSoT) → CarbsViewModelV1 (mapping / formatting) → CarbsViewV1 (render only)
//
//  Key Connections
//  - CarbsViewModelV1: provides formatted values, chart data and today hint text.
...
//  - L10n: localized titles and labels for the carbs metric.
//
...
struct CarbsViewV1: View {
    ...
    // ============================================================
    // MARK: - Header Badge Gate (Nutrition / Carbs)
    // ============================================================

    private var carbsAttentionBadgeV1: Bool {
        ...
        MetricDetailScaffold(
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                NutritionSectionCardScaledV2(
                    sectionTitle: "",
                    title: L10n.Carbs.title,

                    kpiTitle: L10n.Carbs.todayKPI,
                    ...
                    showsWarningBadgeForMetric: { metric in
                        ...
                        case L10n.CarbsDayparts.title: // 🟨 UPDATED
                            return healthStore.carbsAnyAttentionForBadgesV1
